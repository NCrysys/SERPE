...
public class Interface extends javax.swing.JFrame {
    ...
    private void bConfirmarGardarPuntuacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bConfirmarGardarPuntuacionActionPerformed
        String modo;
        if (xogo.isModoClasico()){
            modo="Clásico";
        }
        else{
            modo="Esfera";
        }
        boolean gardado=conexionBD.gardarDatos(xogo.getJugador(), xogo.getPuntuacion(), xogo.getFroitasComidas(), xogo.getBombasComidas(), xogo.getTempo(), modo);
        if (gardado){
            jDGardarPuntuacion.setVisible(false);
